...
//
//	mockgen --source=src/model/service/user_interface.go --destination=src/tests/mocks/user_service_mock.go --package=mocks
//
...
import (
	...
	rest_err "github.com/LucasAntonioC-137/crud-go/src/configuration/rest_err"
	model "github.com/LucasAntonioC-137/crud-go/src/model"
